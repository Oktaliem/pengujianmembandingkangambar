 ...
 * Author : Okta Liem
 */
public class BaseMouseKeyboardAction extends BaseJSExecutorAction {

    public BaseMouseKeyboardAction(WebDriver driver) {
        super(driver);
    }

    @Step
    protected void doubleClick(By el) {
    ...
    @Step
    protected void moveMousePointerTo(By el) {
        WebElement element = driver.findElement(el);
        Actions action = new Actions(driver);
        action.moveToElement(element).perform();
    ...
    @Step
    protected void dragFromAndDropTo(By from, By to) {
    ...
    @Step
    protected void inputTextAndEnter(By el, String value) {
        WebElement element = driver.findElement(el);
        element.clear();
    ...
    @Step
    protected void inputTextAndEnter(WebElement element, String value) {
        element.clear();
        element.sendKeys(value, Keys.ENTER);
    ...
    @Step
    protected void inputTextAndTab(By el, String value) {
        WebElement element = driver.findElement(el);
        element.clear();
    ...
    @Step
    protected void inputTextAndTab(WebElement element, String value) {
        element.clear();
        element.sendKeys(value, Keys.TAB);
    ...
    @Step
    protected void moveMouseAndClick(WebElement move, WebElement target) {
        Actions action = new Actions(driver);
    ...
    @Step
    protected void moveMouseAndClick(By move, By target) {
    ...
    @Step
    protected void selectAutoCompleteDropDownList(WebElement element, String text, int xOffset, int yOffset) {
    ...
    @Step
    protected void clickViaAction(WebElement element) {
        Actions action = new Actions(driver);
